...
public class Main {
    public static void main(String[] args) {
        ...
        IA bot1 = new IA("IA Noir", IA.ALGO.minmax, Pion.COULEUR.noir, 6, IA.STRATEGIE.positionnel);
        IA bot2 = new IA("IA Blanc", IA.ALGO.minmax, Pion.COULEUR.blanc, 6, IA.STRATEGIE.positionnel);
